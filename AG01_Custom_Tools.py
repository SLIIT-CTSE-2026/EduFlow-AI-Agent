...
class EnhancedDiscoveryTool(BaseTool):
    ...
    args_schema: Type[BaseModel] = FileSearchInput # Now it can find this class[cite: 26]

    def _run(self, search_query: str) -> str:
        # Optimization: We extract the first word to avoid search being too specific[cite: 26]
